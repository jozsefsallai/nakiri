...
export const errors = {
  ...
  CANNOT_MANAGE_MEMBERS_IN_THIS_GROUP:
    'You do not have access to managing members in this group.',
  GUILD_NOT_AUTHORIZED:
    'The guild has not been authorized yet. Please authorize it first in the "My Guilds" section.',
  ...
  FAILED_TO_FETCH_USER_DATA:
    "Failed to fetch the user's data from the Discord API.",
  ...
  CANNOT_MANAGE_GUILD_MONITORED_KEYWORDS:
    'You do not have permission to manage monitored keywords.',
...
export const handleError = (error: any, context?: CaptureContext) => {
