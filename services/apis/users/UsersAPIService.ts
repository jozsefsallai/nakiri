...
export class UsersAPIService {
  ...
  public async getDiscordUser(
    discordId: string,
  ): Promise<GetDiscordUserAPIResponse> {
  ...
  public async getAuthorizedUsers(): Promise<GetAuthorizedUsersAPIResponse> {
    return axiosService
      .get(UsersAPIService.GET_AUTHORIZED_USERS_URL)
      .then((res) => res.data);
  }

  public async authorizeDiscordUser({
    discordId,
    permissions,
  }: AuthorizeDiscordUserAPIRequest): Promise<AuthorizeDiscordUserAPIResponse> {
    return axiosService
      .post(UsersAPIService.AUTHORIZE_DISCORD_USER_URL, {
        discordId,
        permissions,
      })
      .then((res) => res.data);
  ...
  public async updateUser({
    hideThumbnails,
  }: UpdateUserAPIRequest): Promise<UpdateUserAPIResponse> {
    return axiosService
      .patch(UsersAPIService.UPDATE_USER_URL, { hideThumbnails })
      .then((res) => res.data);
  }
  ...
  public async updateUserPermissions({
    id,
    permissions,
  }: UpdateUserPermissionsAPIRequest): Promise<UpdateUserPermissionsAPIResponse> {
