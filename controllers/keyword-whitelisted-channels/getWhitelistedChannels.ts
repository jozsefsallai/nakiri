...
import { IKeywordWhitelistedChannel, KeywordWhitelistedChannel } from '@/db/models/keywords/KeywordWhitelistedChannel';

export const getWhitelistedChannels = async (guildId: string): Promise<IKeywordWhitelistedChannel[]> => {
  await db.prepare();
